...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Button ID="Print" class="button" Visible="true" Text="Print" runat="server" onclick="PrintAllPages" />
       ...
       <asp:GridView ID="Grid1" runat="server"  AutoGenerateColumns="False" AllowPaging="true" 
           ...
           OnRowDeleting="Grid1_RowDeleting" DataKeyNames="AID">
            <columns>
           ...
           <edititemtemplate>
           <asp:textbox id="textbox2" runat='server' text='<%#Eval("JudgeID") %>'></asp:textbox>
           </edititemtemplate>
            </asp:templatefield>
           ...
           <edititemtemplate>
           <asp:textbox id="textbox3" runat='server' Text='<%#Eval("ProjectID") %>'></asp:textbox>
           </edititemtemplate>
            </asp:templatefield>
