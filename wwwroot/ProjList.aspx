   ...
   <asp:Panel ID="PnlTable" runat="server">
       <asp:GridView ID="ProjListGrid" runat="server"
           ...
           AllowPaging="True" OnPageIndexChanging="PageIndexChanging" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" DataKeyNames="PID"
            OnRowCancelingEdit="ProjListGrid_RowCancelingEdit" OnRowDeleting="ProjListGrid_RowDeleting" OnRowUpdating="ProjListGrid_RowUpdating" OnRowEditing="ProjListGrid_RowEditing" OnDataBound="ProjListGrid_DataBound">
            <PagerTemplate>
