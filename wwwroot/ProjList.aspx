   ...
   <asp:Panel ID="PnlTable" runat="server">
       <asp:GridView ID="ProjListGrid" runat="server"
           ...
           AllowPaging="True" OnPageIndexChanging="PageIndexChanging" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" DataKeyNames="PID"
            OnRowCancelingEdit="ProjListGrid_RowCancelingEdit" OnRowDataBound="ProjListGrid_RowDataBound" OnRowDeleting="ProjListGrid_RowDeleting" OnRowUpdating="ProjListGrid_RowUpdating" OnRowEditing="ProjListGrid_RowEditing">
            <PagerTemplate>
