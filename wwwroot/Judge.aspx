    ...
    <asp:Panel ID="PnlTable" runat="server">
       <asp:GridView ID="Grid1" runat="server"  AutoGenerateColumns="False" AllowPaging="true" 
           ...
           OnRowDeleting="Grid1_RowDeleting" OnRowEditing="Grid1_RowEditing"
            OnRowUpdating="Grid1_RowUpdating" DataKeyNames="JID">
            <columns>
           ...
           <edititemtemplate>
           <asp:textbox id="textbox3" runat='server' Text='<%#Eval("CategoryA") %>'></asp:textbox>
           </edititemtemplate>
            </asp:templatefield>

            <asp:templatefield headertext="CategoryB"><itemtemplate><%#Eval("CategoryB") %> </itemtemplate>
           <edititemtemplate>
           <asp:textbox id="textbox4" runat='server' text='<%#Eval("CategoryB") %>'></asp:textbox>
           </edititemtemplate>
            </asp:templatefield>

            <asp:templatefield headertext="CategoryC"><itemtemplate><%#Eval("CategoryC") %> </itemtemplate>
           <edititemtemplate>
           <asp:textbox id="textbox5" runat='server' text='<%#Eval("CategoryC") %>'></asp:textbox>
           </edititemtemplate>
            </asp:templatefield>
